(() => {
  ...
  function renderResumoSelecao() {
    ...
    if (!f) {
      $('mov-resumo-selec').innerHTML = `
        ...
        <div class="empty-sub">O resumo e os campos de movimentação serão liberados após a seleção.</div>
      `;
      return;
    }
  ...
  function selectFederal(id, { scroll = true } = {}) {
